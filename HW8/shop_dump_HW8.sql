...
CREATE TABLE `orders` (
  ...
  `comment` text,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=24 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Заказы';
...
INSERT INTO `orders` VALUES (22,0,'2021-10-07 17:33:40',NULL,'mupkckbvigg81eb6bn2c7ipa3m','handling','петя',1212121212,'rerererere'),(23,100009,'2021-10-07 17:33:54','2021-10-07 17:35:08','k8th9jj545cuo3m3bh4c1jl3tc','shipped','коля',111111111111,'khdfpoaisdhpoiasdfh');
...
) ENGINE=InnoDB AUTO_INCREMENT=50 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Состав заказа';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `orders_products` VALUES (46,22,5,1,'2021-10-07 17:33:26','2021-10-07 17:33:40','mupkckbvigg81eb6bn2c7ipa3m'),(47,22,7,1,'2021-10-07 17:33:29','2021-10-07 17:33:40','mupkckbvigg81eb6bn2c7ipa3m'),(48,23,3,1,'2021-10-07 17:33:54',NULL,'k8th9jj545cuo3m3bh4c1jl3tc'),(49,23,5,2,'2021-10-07 17:33:57','2021-10-07 17:34:00','k8th9jj545cuo3m3bh4c1jl3tc');
...
-- Dump completed on 2021-10-07 17:38:45
